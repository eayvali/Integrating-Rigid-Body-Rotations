...
time=0:delt:t_max;
figure
h=loglog(time,error_R_exp,'r',time,error_R_from_nonunit_q_RK4,'b',time,error_R_from_q_exp,'k',time,error_R_from_nonunit_q_zeroc_RK4,'c', time, error_R_rk4, 'y');
legend(h,'R exponential update','RK4 nonunit q (c\neq0)', 'unit quaternion exponential update', 'RK4, nonunit q (c=0)','RK4, R')
